...
int main() {
    ...
    std::string cipher1 = aes_cbc_mode_encrypt(msg1, key, iv);
    start = std::chrono::high_resolution_clock::now();
    for (int i = 0; i < 1000; i++) {
    ...
    std::string cipher2 = aes_cbc_mode_encrypt(msg2, key, iv);
    start = std::chrono::high_resolution_clock::now();
    for (int i = 0; i < 1000; i++) {
    ...
    std::string cipher3 = aes_cbc_mode_encrypt(msg3, key, iv);
    start = std::chrono::high_resolution_clock::now();
    for (int i = 0; i < 1000; i++) {
    ...
    std::string cipher4 = aes_cbc_mode_encrypt(msg4, key, iv);
    start = std::chrono::high_resolution_clock::now();
    for (int i = 0; i < 1000; i++) {
    ...
    std::string cipher5 = aes_cbc_mode_encrypt(msg5, key, iv);
    start = std::chrono::high_resolution_clock::now();
    for (int i = 0; i < 1000; i++) {
