...
std::string aes_cfb_mode_encrypt(std::string &plain, CryptoPP::SecByteBlock key, CryptoPP::byte *iv) {
    std::string cipher;
    std::string output;
...
std::string aes_cfb_mode_decrypt(std::string &encoded, CryptoPP::SecByteBlock key, CryptoPP::byte *iv) {
    std::string cipher;
    std::string output;
...
int main() {
    ...
    for (int i = 0; i < 1000; i++) {
        cipher = aes_cfb_mode_encrypt(msg1, key, iv);
    }
    ...
    start = std::chrono::high_resolution_clock::now();
    for (int i = 0; i < 1000; i++) {
        cipher = aes_cfb_mode_encrypt(msg2, key, iv);
    }
    end = std::chrono::high_resolution_clock::now();
    duration = std::chrono::duration_cast<std::chrono::microseconds> (end - start);
    ...
    start = std::chrono::high_resolution_clock::now();
    for (int i = 0; i < 1000; i++) {
        cipher = aes_cfb_mode_encrypt(msg3, key, iv);
    }
    end = std::chrono::high_resolution_clock::now();
    duration = std::chrono::duration_cast<std::chrono::microseconds> (end - start);
    ...
    start = std::chrono::high_resolution_clock::now();
    for (int i = 0; i < 1000; i++) {
        cipher = aes_cfb_mode_encrypt(msg4, key, iv);
    }
    end = std::chrono::high_resolution_clock::now();
    duration = std::chrono::duration_cast<std::chrono::microseconds> (end - start);
    ...
    start = std::chrono::high_resolution_clock::now();
    for (int i = 0; i < 1000; i++) {
        cipher = aes_cfb_mode_encrypt(msg5, key, iv);
    }
    end = std::chrono::high_resolution_clock::now();
    duration = std::chrono::duration_cast<std::chrono::microseconds> (end - start);
    ...
    std::string cipher1 = aes_cfb_mode_encrypt(msg1, key, iv);
    start = std::chrono::high_resolution_clock::now();
    for (int i = 0; i < 1000; i++) {
        recovered = aes_cfb_mode_decrypt(cipher1, key, iv);
    }
    end = std::chrono::high_resolution_clock::now();
    duration = std::chrono::duration_cast<std::chrono::microseconds> (end - start);
    ...
    std::string cipher2 = aes_cfb_mode_encrypt(msg2, key, iv);
    start = std::chrono::high_resolution_clock::now();
    for (int i = 0; i < 1000; i++) {
        recovered = aes_cfb_mode_decrypt(cipher2, key, iv);
    }
    end = std::chrono::high_resolution_clock::now();
    duration = std::chrono::duration_cast<std::chrono::microseconds> (end - start);
    std::cout << "Recovered: " << recovered << std::endl << std::endl;
    ...
    std::string cipher3 = aes_cfb_mode_encrypt(msg3, key, iv);
    start = std::chrono::high_resolution_clock::now();
    for (int i = 0; i < 1000; i++) {
        recovered = aes_cfb_mode_decrypt(cipher3, key, iv);
    }
    end = std::chrono::high_resolution_clock::now();
    duration = std::chrono::duration_cast<std::chrono::microseconds> (end - start);
    std::cout << "Recovered: " << recovered << std::endl << std::endl;
    ...
    std::string cipher4 = aes_cfb_mode_encrypt(msg4, key, iv);
    start = std::chrono::high_resolution_clock::now();
    for (int i = 0; i < 1000; i++) {
        recovered = aes_cfb_mode_decrypt(cipher4, key, iv);
    }
    end = std::chrono::high_resolution_clock::now();
    duration = std::chrono::duration_cast<std::chrono::microseconds> (end - start);
    std::cout << "Recovered: " << recovered << std::endl << std::endl;
    ...
    std::string cipher5 = aes_cfb_mode_encrypt(msg5, key, iv);
    start = std::chrono::high_resolution_clock::now();
    for (int i = 0; i < 1000; i++) {
        recovered = aes_cfb_mode_decrypt(cipher5, key, iv);
    }
    end = std::chrono::high_resolution_clock::now();
    duration = std::chrono::duration_cast<std::chrono::microseconds> (end - start);
    std::cout << "Recovered: " << recovered << std::endl << std::endl;
