...
std::string aes_ecb_mode_encrypt(std::string &plain, CryptoPP::SecByteBlock key) {
    std::string cipher;
    std::string output;

    try {
        CryptoPP::ECB_Mode<CryptoPP::AES>::Encryption e(key, key.size());
...
std::string aes_ecb_mode_decrypt(std::string &decoded, CryptoPP::SecByteBlock key) {
    std::string cipher;
    std::string output;
    ...
    try {
        CryptoPP::ECB_Mode<CryptoPP::AES>::Decryption d(key, key.size());
        CryptoPP::StringSource(cipher, true,
...
int main() {
    ...
    for (int i = 0; i < 1000; i++) {
        cipher = aes_ecb_mode_encrypt(msg1, key);
    }
    ...
    start = std::chrono::high_resolution_clock::now();
    for (int i = 0; i < 1000; i++) {
        cipher = aes_ecb_mode_encrypt(msg2, key);
    }
    end = std::chrono::high_resolution_clock::now();
    duration = std::chrono::duration_cast<std::chrono::microseconds> (end - start);
    ...
    start = std::chrono::high_resolution_clock::now();
    for (int i = 0; i < 1000; i++) {
        cipher = aes_ecb_mode_encrypt(msg3, key);
    }
    end = std::chrono::high_resolution_clock::now();
    duration = std::chrono::duration_cast<std::chrono::microseconds> (end - start);
    ...
    start = std::chrono::high_resolution_clock::now();
    for (int i = 0; i < 1000; i++) {
        cipher = aes_ecb_mode_encrypt(msg4, key);
    }
    end = std::chrono::high_resolution_clock::now();
    duration = std::chrono::duration_cast<std::chrono::microseconds> (end - start);
    ...
    start = std::chrono::high_resolution_clock::now();
    for (int i = 0; i < 1000; i++) {
        cipher = aes_ecb_mode_encrypt(msg5, key);
    }
    end = std::chrono::high_resolution_clock::now();
    duration = std::chrono::duration_cast<std::chrono::microseconds> (end - start);
    ...
    std::string cipher1 = aes_ecb_mode_encrypt(msg1, key);
    start = std::chrono::high_resolution_clock::now();
    for (int i = 0; i < 1000; i++) {
        recovered = aes_ecb_mode_decrypt(cipher1, key);
    }
    end = std::chrono::high_resolution_clock::now();
    duration = std::chrono::duration_cast<std::chrono::microseconds> (end - start);
    ...
    std::string cipher2 = aes_ecb_mode_encrypt(msg2, key);
    start = std::chrono::high_resolution_clock::now();
    for (int i = 0; i < 1000; i++) {
        recovered = aes_ecb_mode_decrypt(cipher2, key);
    }
    end = std::chrono::high_resolution_clock::now();
    duration = std::chrono::duration_cast<std::chrono::microseconds> (end - start);
    std::cout << "Recovered: " << recovered << std::endl << std::endl;
    ...
    std::string cipher3 = aes_ecb_mode_encrypt(msg3, key);
    start = std::chrono::high_resolution_clock::now();
    for (int i = 0; i < 1000; i++) {
        recovered = aes_ecb_mode_decrypt(cipher3, key);
    }
    end = std::chrono::high_resolution_clock::now();
    duration = std::chrono::duration_cast<std::chrono::microseconds> (end - start);
    std::cout << "Recovered: " << recovered << std::endl << std::endl;
    ...
    std::string cipher4 = aes_ecb_mode_encrypt(msg4, key);
    start = std::chrono::high_resolution_clock::now();
    for (int i = 0; i < 1000; i++) {
        recovered = aes_ecb_mode_decrypt(cipher4, key);
    }
    end = std::chrono::high_resolution_clock::now();
    duration = std::chrono::duration_cast<std::chrono::microseconds> (end - start);
    std::cout << "Recovered: " << recovered << std::endl << std::endl;
    ...
    std::string cipher5 = aes_ecb_mode_encrypt(msg5, key);
    start = std::chrono::high_resolution_clock::now();
    for (int i = 0; i < 1000; i++) {
        recovered = aes_ecb_mode_decrypt(cipher5, key);
    }
    end = std::chrono::high_resolution_clock::now();
    duration = std::chrono::duration_cast<std::chrono::microseconds> (end - start);
    std::cout << "Recovered: " << recovered << std::endl << std::endl;
